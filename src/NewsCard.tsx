import { Avatar, Box, Container, Image, NativeBaseProvider, Text, View } from "native-base";
...
export const NewsCard: React.FC <NewsCardType> = ({name, onNavigationPress}) => {
  return (
    <NativeBaseProvider>
      <SafeAreaView>
        <Text>{name}</Text>
        <Container>
          <View>
            <View style={{ flex: 0 }}>
              ...
              <View>
                <View>
                  <Button title={"Details"} style={{ color: "green" }} onPress={onNavigationPress} />
                </View>
              </View>
            </View>
          </View>
